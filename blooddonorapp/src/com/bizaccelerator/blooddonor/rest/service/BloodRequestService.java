...
@Path("/submitBloodRequest")
public class BloodRequestService {
 
    @POST
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    public Response createMessage(@FormParam("datepicker") String datepicker,
        ...
        //if(name.trim().length() > 0 && message.trim().length() > 0 && !list.isEmpty()) {
    		...
    		bloodDonorDBUtil.createBloodRequest(datepicker, bloodGroup, quantity, place, city);
